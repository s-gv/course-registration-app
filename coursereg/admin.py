...
class CustomUserAdmin(UserAdmin):
    fieldsets = (
        ...
        (None, {'fields': ('full_name', 'department', 'user_type', 'adviser', 'degree', 'sr_no', 'cgpa', 'telephone', 'is_active', 'is_dcc_review_pending', 'is_dcc_sent_notification', 'is_adviser_review_pending')}),
